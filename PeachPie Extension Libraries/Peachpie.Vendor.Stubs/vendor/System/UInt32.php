...
final class UInt32 extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	const MinValue = '0';
	/**
	 * @uses UInt32Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses UInt32Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses UInt32Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses UInt32Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses UInt32Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses UInt32Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt32Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt32Override::Parse_6 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\UInt32|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses UInt32Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses UInt32Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses UInt32Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt32Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt32Override::TryParse_5 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses UInt32Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\UInt32,System\UInt32]
	 */
	 ...
	 * @uses UInt32Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt32Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt32Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt32Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt32Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt32Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

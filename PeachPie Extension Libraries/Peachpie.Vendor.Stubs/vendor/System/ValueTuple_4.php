...
trait ValueTuple_4Override {
	...
	/**
	 * @deprecated
	 * @param \System\ValueTuple_4 $other [generic: T1,T2,T3,T4]
	 * @return \System\Int32|int
	 */
...
final class ValueTuple_4 extends \System\ValueType implements
	\System\IEquatable_1,
	...
	\System\Runtime\CompilerServices\ITuple
{
	...
	public $Item4;
	/**
	 * @uses ValueTuple_4Override::CompareTo_1 <br>private , args: ($other)<br>
	 * @uses ValueTuple_4Override::CompareTo_2 <br>public , args: ($other)<br>
	 * @uses ValueTuple_4Override::CompareTo_3 <br>private , args: ($other, $comparer)<br>
	 ...
	 * @uses ValueTuple_4Override::GetHashCode_1 <br>private , args: ($comparer)<br>
	 * @uses ValueTuple_4Override::GetHashCode_2 <br>private , args: ($comparer)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */

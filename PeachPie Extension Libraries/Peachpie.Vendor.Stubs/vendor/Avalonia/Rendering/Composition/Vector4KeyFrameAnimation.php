...
*/
trait Vector4KeyFrameAnimationOverride {
	/**
	 * @deprecated
...
{
	use Vector4KeyFrameAnimationOverride;
	/**
	 * @field
	...
	public $IsDisposed;
	/**
	 * @uses Vector4KeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses Vector4KeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

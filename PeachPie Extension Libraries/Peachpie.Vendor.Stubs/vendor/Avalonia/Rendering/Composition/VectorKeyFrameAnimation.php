...
*/
trait VectorKeyFrameAnimationOverride {
	/**
	 * @deprecated
...
{
	use VectorKeyFrameAnimationOverride;
	/**
	 * @field
	...
	public $IsDisposed;
	/**
	 * @uses VectorKeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses VectorKeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

...
*/
trait ScalarKeyFrameAnimationOverride {
	/**
	 * @deprecated
	...
	\Avalonia\Rendering\Composition\Animations\ICompositionAnimationBase
{
	...
	public $IsDisposed;
	/**
	 * @uses ScalarKeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses ScalarKeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

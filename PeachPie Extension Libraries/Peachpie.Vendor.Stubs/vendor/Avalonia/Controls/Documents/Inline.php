	...
	\Avalonia\INamed
{
	 ...
	 */
	public static $BaselineAlignmentProperty;
	/**
	 * @property
	 ...
	 */
	public static function GetTextDecorations($control){}
	/**
	 * @param \Avalonia\Controls\Control $control
	 * @param \Avalonia\Media\TextDecorationCollection $value
	 * @return \System\Void|void
	 */
	public static function SetTextDecorations($control, $value){}
	/**
	 * @param \System\Collections\Generic\IList_1 $textRuns [generic: Avalonia\Media\TextFormatting\TextRun]
	 * @return \System\Void|void
	 */
	abstract protected function BuildTextRun($textRuns);
	/**
	 * @param \System\Text\StringBuilder $stringBuilder
	 * @return \System\Void|void
	 */
	abstract protected function AppendText($stringBuilder);
	/**

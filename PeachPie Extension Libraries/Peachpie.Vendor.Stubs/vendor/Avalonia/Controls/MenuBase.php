	...
	\Avalonia\Controls\IMenuElement
{
	 ...
	 */
	public static $OpenedEvent;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\Interactivity\RoutedEvent_1[Avalonia\Interactivity\RoutedEventArgs]
	 */
	public static $ClosedEvent;
	/**
	 * @property
	...
	public $Item;
	/**
	 * @uses MenuBaseOverride::get_InteractionHandler_1 <br>private , args: ()<br>
	 * @uses MenuBaseOverride::get_InteractionHandler_2 <br>protected , args: ()<br>
	 * @var mixed|\override ...$args
	 * @return \Avalonia\Controls\Platform\IMenuInteractionHandler|mixed|\override
	 */
	#[MethodOverrideProtected]function get_InteractionHandler (){}

	...
	\Avalonia\Styling\ISetterValue
{
	 ...
	 */
	public static $DragStartedEvent;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\Interactivity\RoutedEvent_1[Avalonia\Input\VectorEventArgs]
	 */
	public static $DragDeltaEvent;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\Interactivity\RoutedEvent_1[Avalonia\Input\VectorEventArgs]
	 */
	public static $DragCompletedEvent;
	/**
	 * @property
	...
	public $Item;
	/**
	 * @param \System\EventHandler_1 $value [generic: Avalonia\Input\VectorEventArgs]

	...
	\Avalonia\Input\IClickableControl
{
	 ...
	 */
	public static $ClickModeProperty;
	/**
	 * @field
	 * @since readonly
	 ...
	 */
	public static $IsDefaultProperty;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\StyledProperty_1[System\Boolean]
	 */
	public static $IsCancelProperty;
	/**
	 * @field
	 * @since readonly
	 ...
	 * @uses ButtonOverride::CanExecuteChanged_1 <br>private , args: ($sender, $e)<br>
	 * @uses ButtonOverride::CanExecuteChanged_2 <br>private , args: ($sender, $e)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Void|void|mixed|\override
	 */
	#[MethodOverridePrivate]function CanExecuteChanged (\override ...$args){}
	private function RegisterFlyoutEvents($flyout){}
	private function UnregisterFlyoutEvents($flyout){}
	private function ListenForDefault($root){}
	private function ListenForCancel($root){}
	private function StopListeningForDefault($root){}
	private function StopListeningForCancel($root){}
	private function RootDefaultKeyDown($sender, $e){}
	private function RootCancelKeyDown($sender, $e){}
	private function RaiseClick(){}
	private function Flyout_Opened($sender, $e){}
	private function Flyout_Closed($sender, $e){}

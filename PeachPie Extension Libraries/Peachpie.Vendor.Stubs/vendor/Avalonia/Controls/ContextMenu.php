...
trait ContextMenuOverride {
	 ...
	 */
	#[MethodOverride]private function Open_1 ($control, $placementTarget, $placement){}
	/**
	 */
	#[MethodOverride]public function __construct_1 (){}
	/**
	 * @param \Avalonia\Controls\Platform\IMenuInteractionHandler $interactionHandler
	 */
	#[MethodOverride]public function __construct_2 ($interactionHandler){}
}
	...
	\Avalonia\Controls\Diagnostics\IPopupHostProvider
{
	...
	private static function ContextMenuChanged($e){}
	...
	private function PopupClosing($sender, $e){}
	private function PopupClosed($sender, $e){}
	private function PopupKeyUp($sender, $e){}
	private static function ControlContextRequested($sender, $e){}
	private static function ControlOnAttachedToVisualTree($sender, $e){}
	private static function AttachControlToContextMenu($sender){}
	private static function ControlDetachedFromVisualTree($sender, $e){}
	...
	/**
	 * @uses ContextMenuOverride::__construct_1 <br>public , args: ()<br>
	 * @uses ContextMenuOverride::__construct_2 <br>public , args: ($interactionHandler)<br>

 ...
 */
trait EffectAnimatorMethodsOverride
{
	/**
...
/**
 */
class EffectAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	 ...
	 * @return @deprecated
	 */
	#[MethodPrivate]  function TryCreateAnimator($animator){}
	/**
	 * @return \System\Void|void
	 */
	public static function EnsureRegistered(){}
	/**
	 * @uses EffectAnimatorMethodsOverride::get_Count_1 ()
	 * @uses EffectAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses EffectAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses EffectAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses EffectAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses EffectAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses EffectAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::Add_1 ($item)
	 * @uses EffectAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::Clear_1 ()
	 * @uses EffectAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses EffectAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses EffectAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses EffectAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses EffectAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses EffectAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses EffectAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses EffectAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses EffectAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses EffectAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

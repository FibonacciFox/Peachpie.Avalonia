 ...
 */
trait ISolidColorBrushAnimatorMethodsOverride
{
	/**
...
{
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_Count_1 ()
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Add_1 ($item)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Clear_1 ()
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses ISolidColorBrushAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses ISolidColorBrushAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses ISolidColorBrushAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses ISolidColorBrushAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

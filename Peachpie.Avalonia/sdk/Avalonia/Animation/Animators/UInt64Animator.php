 ...
 */
trait UInt64AnimatorMethodsOverride
{
	/**
...
/**
 */
class UInt64Animator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses UInt64AnimatorMethodsOverride::get_Count_1 ()
	 * @uses UInt64AnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses UInt64AnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses UInt64AnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses UInt64AnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses UInt64AnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses UInt64AnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::Add_1 ($item)
	 * @uses UInt64AnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::Clear_1 ()
	 * @uses UInt64AnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::Contains_1 ($item)
	 * @uses UInt64AnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses UInt64AnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses UInt64AnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses UInt64AnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses UInt64AnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses UInt64AnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::Remove_1 ($item)
	 * @uses UInt64AnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses UInt64AnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses UInt64AnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

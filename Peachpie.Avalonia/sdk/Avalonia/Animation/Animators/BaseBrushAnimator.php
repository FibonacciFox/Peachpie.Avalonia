 ...
 */
trait BaseBrushAnimatorMethodsOverride
{
	/**
...
/**
 */
class BaseBrushAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	 ...
	 * @return \System\Void|void
	 */
	public static function RegisterBrushAnimator($condition){}
	/**
	 * @param \Avalonia\Animation\IAnimator& $animator
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate]  function TryCreateGradientAnimator($animator){}
	/**
	 * @param \Avalonia\Animation\IAnimator& $animator
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate]  function TryCreateSolidColorBrushAnimator($animator){}
	/**
	 * @param \Avalonia\Animation\IAnimator& $animator
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate]  function TryCreateCustomRegisteredAnimator($animator){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::get_Count_1 ()
	 * @uses BaseBrushAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses BaseBrushAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses BaseBrushAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses BaseBrushAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::Add_1 ($item)
	 * @uses BaseBrushAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::Clear_1 ()
	 * @uses BaseBrushAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses BaseBrushAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses BaseBrushAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses BaseBrushAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses BaseBrushAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses BaseBrushAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses BaseBrushAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses BaseBrushAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses BaseBrushAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses BaseBrushAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait ServerCompositionDrawListVisualMethodsOverride
{
	/**
...
/**
 */
class ServerCompositionDrawListVisual extends \Avalonia\Rendering\Composition\Server\ServerCompositionContainerVisual implements 
	...
	\Avalonia\Rendering\Composition\Server\IServerRenderResourceObserver
{
	...
	/**
	 * @uses ServerCompositionDrawListVisualMethodsOverride::SetValue_1 ($prop, $field, $value)
	 * @uses ServerCompositionDrawListVisualMethodsOverride::SetValue_2 ($prop, $field, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function SetValue(mixed ...$args){}
	/**
	 * @uses ServerCompositionDrawListVisualMethodsOverride::GetValue_1 ($prop, $field)
	 * @uses ServerCompositionDrawListVisualMethodsOverride::GetValue_2 ($prop, $field)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetValue(mixed ...$args){}
	/**
	 * @uses ServerCompositionDrawListVisualMethodsOverride::SetAnimatedValue_1 ($prop, $field, $committedAt, $animation)
	 * @uses ServerCompositionDrawListVisualMethodsOverride::SetAnimatedValue_2 ($property, $field, $value)
	 * @return mixed|@override
	 */

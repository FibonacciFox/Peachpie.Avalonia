 ...
 */
trait Vector3KeyFrameAnimationMethodsOverride
{
	/**
...
/**
 */
class Vector3KeyFrameAnimation extends \Avalonia\Rendering\Composition\Animations\KeyFrameAnimation implements 
	...
	\Avalonia\Rendering\Composition\Animations\ICompositionAnimationBase
{
	...
	/**
	 * @uses Vector3KeyFrameAnimationMethodsOverride::InsertKeyFrame_1 ($normalizedProgressKey, $value, $easingFunction)
	 * @uses Vector3KeyFrameAnimationMethodsOverride::InsertKeyFrame_2 ($normalizedProgressKey, $value)
	...
	/**
	 * @uses Vector3KeyFrameAnimationMethodsOverride::StartAnimation_1 ($propertyName, $animation)
	 * @uses Vector3KeyFrameAnimationMethodsOverride::StartAnimation_2 ($propertyName, $animation, $finalValue)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function StartAnimation(mixed ...$args){}
	/**
	 * @uses Vector3KeyFrameAnimationMethodsOverride::StartAnimationGroup_1 ($grp)
	 * @uses Vector3KeyFrameAnimationMethodsOverride::StartAnimationGroup_2 ($grp, $target, $finalValue)
	 * @return mixed|@override
	 */

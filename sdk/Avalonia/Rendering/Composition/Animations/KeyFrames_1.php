 ...
 */
trait KeyFrames_1MethodsOverride
{
	/**
	 * @return \System\Void|void
	 */
	#[MethodOverride] public  function Insert_1($normalizedProgressKey, $value, $easingFunction){}
	/**
	 * @return \System\Void|void
	 */
	#[MethodOverride] public  function Insert_2($index, $item){}
	/**
	 * @return \System\Void|void
	 */
	#[MethodOverride] private  function Insert_3($index, $item){}
	/**
	...
	/**
	 * @return \Avalonia\Rendering\Composition\Animations\KeyFrame_1
	 */
	...
	\Avalonia\Rendering\Composition\Animations\IKeyFrames
{
	 ...
	 * @return @deprecated
	 */
	#[MethodPrivate]  function Validate($key){}
	/**
	...
	/**
	 * @uses KeyFrames_1MethodsOverride::Insert_1 ($normalizedProgressKey, $value, $easingFunction)
	 * @uses KeyFrames_1MethodsOverride::Insert_2 ($index, $item)
	 * @uses KeyFrames_1MethodsOverride::Insert_3 ($index, $item)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @return \Avalonia\Rendering\Composition\Animations\ServerKeyFrame_1[]
	 */
	...
	/**
	 * @uses KeyFrames_1MethodsOverride::get_IsReadOnly_1 ()
	 * @uses KeyFrames_1MethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses KeyFrames_1MethodsOverride::get_Item_1 ($index)
	 * @uses KeyFrames_1MethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::set_Item_1 ($index, $value)
	 * @uses KeyFrames_1MethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::Add_1 ($item)
	 * @uses KeyFrames_1MethodsOverride::Add_2 ($item)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::BinarySearch_1 ($index, $count, $item, $comparer)
	 * @uses KeyFrames_1MethodsOverride::BinarySearch_2 ($item)
	 * @uses KeyFrames_1MethodsOverride::BinarySearch_3 ($item, $comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function BinarySearch(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::Contains_1 ($item)
	 * @uses KeyFrames_1MethodsOverride::Contains_2 ($item)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::CopyTo_1 ($array)
	 * @uses KeyFrames_1MethodsOverride::CopyTo_2 ($array, $arrayIndex)
	 * @uses KeyFrames_1MethodsOverride::CopyTo_3 ($index, $array, $arrayIndex, $count)
	 * @uses KeyFrames_1MethodsOverride::CopyTo_4 ($array, $arrayIndex)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::FindIndex_1 ($match)
	 * @uses KeyFrames_1MethodsOverride::FindIndex_2 ($startIndex, $match)
	 * @uses KeyFrames_1MethodsOverride::FindIndex_3 ($startIndex, $count, $match)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function FindIndex(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::FindLastIndex_1 ($match)
	 * @uses KeyFrames_1MethodsOverride::FindLastIndex_2 ($startIndex, $match)
	 * @uses KeyFrames_1MethodsOverride::FindLastIndex_3 ($startIndex, $count, $match)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function FindLastIndex(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::GetEnumerator_1 ()
	 * @uses KeyFrames_1MethodsOverride::GetEnumerator_2 ()
	 * @uses KeyFrames_1MethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::IndexOf_1 ($item)
	 * @uses KeyFrames_1MethodsOverride::IndexOf_2 ($item)
	 * @uses KeyFrames_1MethodsOverride::IndexOf_3 ($item, $index)
	 * @uses KeyFrames_1MethodsOverride::IndexOf_4 ($item, $index, $count)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::LastIndexOf_1 ($item)
	 * @uses KeyFrames_1MethodsOverride::LastIndexOf_2 ($item, $index)
	 * @uses KeyFrames_1MethodsOverride::LastIndexOf_3 ($item, $index, $count)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function LastIndexOf(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::Remove_1 ($item)
	 * @uses KeyFrames_1MethodsOverride::Remove_2 ($item)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::Reverse_1 ()
	 * @uses KeyFrames_1MethodsOverride::Reverse_2 ($index, $count)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Reverse(mixed ...$args){}
	/**
	 * @uses KeyFrames_1MethodsOverride::Sort_1 ()
	 * @uses KeyFrames_1MethodsOverride::Sort_2 ($comparer)
	 * @uses KeyFrames_1MethodsOverride::Sort_3 ($index, $count, $comparer)
	 * @uses KeyFrames_1MethodsOverride::Sort_4 ($comparison)
	 * @return mixed|@override
	 */

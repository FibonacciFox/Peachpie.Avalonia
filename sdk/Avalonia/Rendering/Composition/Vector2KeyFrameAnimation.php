 ...
 */
trait Vector2KeyFrameAnimationMethodsOverride
{
	/**
...
/**
 */
class Vector2KeyFrameAnimation extends \Avalonia\Rendering\Composition\Animations\KeyFrameAnimation implements 
	...
	\Avalonia\Rendering\Composition\Animations\ICompositionAnimationBase
{
	...
	/**
	 * @uses Vector2KeyFrameAnimationMethodsOverride::InsertKeyFrame_1 ($normalizedProgressKey, $value, $easingFunction)
	 * @uses Vector2KeyFrameAnimationMethodsOverride::InsertKeyFrame_2 ($normalizedProgressKey, $value)
	...
	/**
	 * @uses Vector2KeyFrameAnimationMethodsOverride::StartAnimation_1 ($propertyName, $animation)
	 * @uses Vector2KeyFrameAnimationMethodsOverride::StartAnimation_2 ($propertyName, $animation, $finalValue)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function StartAnimation(mixed ...$args){}
	/**
	 * @uses Vector2KeyFrameAnimationMethodsOverride::StartAnimationGroup_1 ($grp)
	 * @uses Vector2KeyFrameAnimationMethodsOverride::StartAnimationGroup_2 ($grp, $target, $finalValue)
	 * @return mixed|@override
	 */

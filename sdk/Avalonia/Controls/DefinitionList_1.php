 ...
 */
trait DefinitionList_1MethodsOverride
{
	/**
	...
	\Avalonia\Diagnostics\INotifyCollectionChangedDebug
{
	 ...
	 * @return @deprecated
	 */
	#[MethodPrivate]  function SetParent($value){}
	/**
	 ...
	 * @param \System\Boolean $wasRemoved
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate]  function UpdateDefinitionParent($items, $wasRemoved){}
	/**
	 * @uses DefinitionList_1MethodsOverride::get_Count_1 ()
	 * @uses DefinitionList_1MethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses DefinitionList_1MethodsOverride::get_IsReadOnly_1 ()
	 * @uses DefinitionList_1MethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses DefinitionList_1MethodsOverride::get_Item_1 ($index)
	 * @uses DefinitionList_1MethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::set_Item_1 ($index, $value)
	 * @uses DefinitionList_1MethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::Add_1 ($item)
	 * @uses DefinitionList_1MethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::Clear_1 ()
	 * @uses DefinitionList_1MethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::Contains_1 ($item)
	 * @uses DefinitionList_1MethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses DefinitionList_1MethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::GetEnumerator_1 ()
	 * @uses DefinitionList_1MethodsOverride::GetEnumerator_2 ()
	 * @uses DefinitionList_1MethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::IndexOf_1 ($item)
	 * @uses DefinitionList_1MethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::Insert_1 ($index, $item)
	 * @uses DefinitionList_1MethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::Remove_1 ($item)
	 * @uses DefinitionList_1MethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses DefinitionList_1MethodsOverride::RemoveAt_1 ($index)
	 * @uses DefinitionList_1MethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

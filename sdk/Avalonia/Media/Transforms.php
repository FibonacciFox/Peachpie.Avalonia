 ...
 */
trait TransformsMethodsOverride
{
	/**
...
/**
 */
class Transforms extends \Avalonia\Collections\AvaloniaList_1 implements 
	...
	\Avalonia\Diagnostics\INotifyCollectionChangedDebug
{
	...
	/**
	 * @uses TransformsMethodsOverride::get_IsReadOnly_1 ()
	 * @uses TransformsMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses TransformsMethodsOverride::get_Item_1 ($index)
	 * @uses TransformsMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::set_Item_1 ($index, $value)
	 * @uses TransformsMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::Add_1 ($item)
	 * @uses TransformsMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::Clear_1 ()
	 * @uses TransformsMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::Contains_1 ($item)
	 * @uses TransformsMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses TransformsMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::GetEnumerator_1 ()
	 * @uses TransformsMethodsOverride::GetEnumerator_2 ()
	 * @uses TransformsMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::IndexOf_1 ($item)
	 * @uses TransformsMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::Insert_1 ($index, $item)
	 * @uses TransformsMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::Remove_1 ($item)
	 * @uses TransformsMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses TransformsMethodsOverride::RemoveAt_1 ($index)
	 * @uses TransformsMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

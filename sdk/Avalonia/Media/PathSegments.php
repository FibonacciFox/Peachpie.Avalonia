 ...
 */
trait PathSegmentsMethodsOverride
{
	/**
	...
	/**
	 * @return \Avalonia\Media\PathSegment
	 */
...
/**
 */
class PathSegments extends \Avalonia\Collections\AvaloniaList_1 implements 
	...
	\Avalonia\Diagnostics\INotifyCollectionChangedDebug
{
	...
	/**
	 * @uses PathSegmentsMethodsOverride::get_IsReadOnly_1 ()
	 * @uses PathSegmentsMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses PathSegmentsMethodsOverride::get_Item_1 ($index)
	 * @uses PathSegmentsMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::set_Item_1 ($index, $value)
	 * @uses PathSegmentsMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::Add_1 ($item)
	 * @uses PathSegmentsMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::Clear_1 ()
	 * @uses PathSegmentsMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::Contains_1 ($item)
	 * @uses PathSegmentsMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses PathSegmentsMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::GetEnumerator_1 ()
	 * @uses PathSegmentsMethodsOverride::GetEnumerator_2 ()
	 * @uses PathSegmentsMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::IndexOf_1 ($item)
	 * @uses PathSegmentsMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::Insert_1 ($index, $item)
	 * @uses PathSegmentsMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::Remove_1 ($item)
	 * @uses PathSegmentsMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses PathSegmentsMethodsOverride::RemoveAt_1 ($index)
	 * @uses PathSegmentsMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

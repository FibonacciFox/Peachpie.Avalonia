 ...
 */
trait GradientStopsMethodsOverride
{
	/**
	...
	/**
	 * @return \Avalonia\Media\GradientStop
	 */
...
/**
 */
class GradientStops extends \Avalonia\Collections\AvaloniaList_1 implements 
	...
	\Avalonia\Diagnostics\INotifyCollectionChangedDebug
{
	...
	/**
	 * @var \System\Action_1[Avalonia\Media\GradientStop]
	 * @property
	 */
	public $Validate;
	/**
	 * @var \Avalonia\Media\GradientStop
	 * @property
	 */
	public $Item;
	/**
	...
	/**
	 * @uses GradientStopsMethodsOverride::get_Count_1 ()
	 * @uses GradientStopsMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses GradientStopsMethodsOverride::get_IsReadOnly_1 ()
	 * @uses GradientStopsMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses GradientStopsMethodsOverride::get_Item_1 ($index)
	 * @uses GradientStopsMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::set_Item_1 ($index, $value)
	 * @uses GradientStopsMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::Add_1 ($item)
	 * @uses GradientStopsMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::Clear_1 ()
	 * @uses GradientStopsMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::Contains_1 ($item)
	 * @uses GradientStopsMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses GradientStopsMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::GetEnumerator_1 ()
	 * @uses GradientStopsMethodsOverride::GetEnumerator_2 ()
	 * @uses GradientStopsMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::IndexOf_1 ($item)
	 * @uses GradientStopsMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::Insert_1 ($index, $item)
	 * @uses GradientStopsMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::Remove_1 ($item)
	 * @uses GradientStopsMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses GradientStopsMethodsOverride::RemoveAt_1 ($index)
	 * @uses GradientStopsMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait RectAnimatorMethodsOverride
{
	/**
...
/**
 */
class RectAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses RectAnimatorMethodsOverride::get_Count_1 ()
	 * @uses RectAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses RectAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses RectAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses RectAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses RectAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses RectAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::Add_1 ($item)
	 * @uses RectAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::Clear_1 ()
	 * @uses RectAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses RectAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses RectAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses RectAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses RectAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses RectAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses RectAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses RectAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses RectAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses RectAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

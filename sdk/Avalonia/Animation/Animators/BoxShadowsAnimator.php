 ...
 */
trait BoxShadowsAnimatorMethodsOverride
{
	/**
...
/**
 */
class BoxShadowsAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::get_Count_1 ()
	 * @uses BoxShadowsAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses BoxShadowsAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses BoxShadowsAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses BoxShadowsAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::Add_1 ($item)
	 * @uses BoxShadowsAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::Clear_1 ()
	 * @uses BoxShadowsAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses BoxShadowsAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses BoxShadowsAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses BoxShadowsAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses BoxShadowsAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses BoxShadowsAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses BoxShadowsAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses BoxShadowsAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses BoxShadowsAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses BoxShadowsAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait FloatAnimatorMethodsOverride
{
	/**
...
/**
 */
class FloatAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @uses FloatAnimatorMethodsOverride::get_Count_1 ()
	 * @uses FloatAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses FloatAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses FloatAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses FloatAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses FloatAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses FloatAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::Add_1 ($item)
	 * @uses FloatAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::Clear_1 ()
	 * @uses FloatAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses FloatAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses FloatAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses FloatAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses FloatAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses FloatAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses FloatAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses FloatAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses FloatAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses FloatAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

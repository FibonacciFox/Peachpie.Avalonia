 ...
 */
trait DecimalAnimatorMethodsOverride
{
	/**
...
/**
 */
class DecimalAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses DecimalAnimatorMethodsOverride::get_Count_1 ()
	 * @uses DecimalAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses DecimalAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses DecimalAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses DecimalAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses DecimalAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses DecimalAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::Add_1 ($item)
	 * @uses DecimalAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::Clear_1 ()
	 * @uses DecimalAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses DecimalAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses DecimalAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses DecimalAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses DecimalAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses DecimalAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses DecimalAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses DecimalAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses DecimalAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses DecimalAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait BoxShadowAnimatorMethodsOverride
{
	/**
...
/**
 */
class BoxShadowAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::get_Count_1 ()
	 * @uses BoxShadowAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses BoxShadowAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses BoxShadowAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses BoxShadowAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::Add_1 ($item)
	 * @uses BoxShadowAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::Clear_1 ()
	 * @uses BoxShadowAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses BoxShadowAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses BoxShadowAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses BoxShadowAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses BoxShadowAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses BoxShadowAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses BoxShadowAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses BoxShadowAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses BoxShadowAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses BoxShadowAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

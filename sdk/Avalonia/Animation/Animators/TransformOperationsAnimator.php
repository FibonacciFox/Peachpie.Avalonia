 ...
 */
trait TransformOperationsAnimatorMethodsOverride
{
	/**
...
/**
 */
class TransformOperationsAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	 ...
	 */
	protected static function EnsureOperations($value){}
	/**
	 * @param \Avalonia\Animation\AnimatorKeyFrame $kf
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate]  function ValidateTransform($kf){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::get_Count_1 ()
	 * @uses TransformOperationsAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses TransformOperationsAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses TransformOperationsAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses TransformOperationsAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::Add_1 ($item)
	 * @uses TransformOperationsAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::Clear_1 ()
	 * @uses TransformOperationsAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses TransformOperationsAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses TransformOperationsAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses TransformOperationsAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses TransformOperationsAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses TransformOperationsAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses TransformOperationsAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses TransformOperationsAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses TransformOperationsAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses TransformOperationsAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait ColorAnimatorMethodsOverride
{
	/**
...
/**
 */
class ColorAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @param \System\Double|double $linear
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate] static function OECF_sRGB($linear){}
	/**
	 * @param \System\Double|double $srgb
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate] static function EOCF_sRGB($srgb){}
	/**
	 * @param \System\Double|double $progress
	 * @param \Avalonia\Media\Color $oldValue
	 * @param \Avalonia\Media\Color $newValue
	 * @return \Avalonia\Media\Color
	 */
	protected static function InterpolateCore($progress, $oldValue, $newValue){}
	/**
	 * @uses ColorAnimatorMethodsOverride::get_Count_1 ()
	 * @uses ColorAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses ColorAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses ColorAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses ColorAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses ColorAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses ColorAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::Add_1 ($item)
	 * @uses ColorAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::Clear_1 ()
	 * @uses ColorAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses ColorAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses ColorAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses ColorAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses ColorAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses ColorAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses ColorAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses ColorAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses ColorAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses ColorAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

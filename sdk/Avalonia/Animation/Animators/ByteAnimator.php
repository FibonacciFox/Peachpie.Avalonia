 ...
 */
trait ByteAnimatorMethodsOverride
{
	/**
...
/**
 */
class ByteAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @uses ByteAnimatorMethodsOverride::get_Count_1 ()
	 * @uses ByteAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses ByteAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses ByteAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses ByteAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses ByteAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses ByteAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::Add_1 ($item)
	 * @uses ByteAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::Clear_1 ()
	 * @uses ByteAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses ByteAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses ByteAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses ByteAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses ByteAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses ByteAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses ByteAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses ByteAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses ByteAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses ByteAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait SizeAnimatorMethodsOverride
{
	/**
...
/**
 */
class SizeAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses SizeAnimatorMethodsOverride::get_Count_1 ()
	 * @uses SizeAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses SizeAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses SizeAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses SizeAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses SizeAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses SizeAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::Add_1 ($item)
	 * @uses SizeAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::Clear_1 ()
	 * @uses SizeAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses SizeAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses SizeAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses SizeAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses SizeAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses SizeAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses SizeAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses SizeAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses SizeAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses SizeAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

 ...
 */
trait PointAnimatorMethodsOverride
{
	/**
...
/**
 */
class PointAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
	...
	\Avalonia\Animation\IAnimator
{
	...
	public $Capacity;
	/**
	 * @uses PointAnimatorMethodsOverride::get_Count_1 ()
	 * @uses PointAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses PointAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses PointAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses PointAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses PointAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses PointAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::Add_1 ($item)
	 * @uses PointAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::Clear_1 ()
	 * @uses PointAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses PointAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses PointAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses PointAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses PointAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses PointAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses PointAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses PointAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses PointAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses PointAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

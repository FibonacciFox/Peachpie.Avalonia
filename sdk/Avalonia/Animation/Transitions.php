 ...
 */
trait TransitionsMethodsOverride
{
	/**
	...
	/**
	 * @return \Avalonia\Animation\ITransition
	 */
...
/**
 */
class Transitions extends \Avalonia\Collections\AvaloniaList_1 implements 
	...
	\Avalonia\Diagnostics\INotifyCollectionChangedDebug
{
	 ...
	 * @return @deprecated
	 */
	#[MethodPrivate]  function ValidateTransition($obj){}
	/**
	 * @uses TransitionsMethodsOverride::get_Count_1 ()
	 * @uses TransitionsMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses TransitionsMethodsOverride::get_IsReadOnly_1 ()
	 * @uses TransitionsMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses TransitionsMethodsOverride::get_Item_1 ($index)
	 * @uses TransitionsMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::set_Item_1 ($index, $value)
	 * @uses TransitionsMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::Add_1 ($item)
	 * @uses TransitionsMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::Clear_1 ()
	 * @uses TransitionsMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::Contains_1 ($item)
	 * @uses TransitionsMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses TransitionsMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::GetEnumerator_1 ()
	 * @uses TransitionsMethodsOverride::GetEnumerator_2 ()
	 * @uses TransitionsMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::IndexOf_1 ($item)
	 * @uses TransitionsMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::Insert_1 ($index, $item)
	 * @uses TransitionsMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::Remove_1 ($item)
	 * @uses TransitionsMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses TransitionsMethodsOverride::RemoveAt_1 ($index)
	 * @uses TransitionsMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

	...
	\System\Runtime\CompilerServices\ITuple
{
	...
	/**
	 * @uses Tuple_6MethodsOverride::Equals_1 ($obj)
	 * @uses Tuple_6MethodsOverride::Equals_2 ($other, $comparer)
	 * @uses Tuple_6MethodsOverride::Equals_3 ($other, $comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Equals(mixed ...$args){}
	/**
	 * @uses Tuple_6MethodsOverride::CompareTo_1 ($obj)
	 * @uses Tuple_6MethodsOverride::CompareTo_2 ($other, $comparer)
	 * @uses Tuple_6MethodsOverride::CompareTo_3 ($other, $comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CompareTo(mixed ...$args){}
	/**
	 * @uses Tuple_6MethodsOverride::GetHashCode_1 ()
	 * @uses Tuple_6MethodsOverride::GetHashCode_2 ($comparer)
	 * @uses Tuple_6MethodsOverride::GetHashCode_3 ($comparer)
	 * @uses Tuple_6MethodsOverride::GetHashCode_4 ($comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetHashCode(mixed ...$args){}
	/**
	 * @uses Tuple_6MethodsOverride::ToString_1 ()
	 * @uses Tuple_6MethodsOverride::ToString_2 ($sb)
	 * @uses Tuple_6MethodsOverride::ToString_3 ($sb)
	 * @return mixed|@override
	 */

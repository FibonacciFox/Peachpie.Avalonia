 ...
 */
trait SignaturePointerTypeMethodsOverride
{
	/**
	 * @return \System\Type
	 */
...
/**
 */
class SignaturePointerType extends \System\Reflection\SignatureHasElementType implements 
	...
	\System\Reflection\IReflect
{
	...
	/**
	 * @uses SignaturePointerTypeMethodsOverride::MakeArrayType_1 ()
	 * @uses SignaturePointerTypeMethodsOverride::MakeArrayType_2 ($rank)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function MakeArrayType(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::get_Module_1 ()
	 * @uses SignaturePointerTypeMethodsOverride::get_Module_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Module(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructors_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructors_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetConstructors(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetEvent_1 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetEvent_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEvent(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetEvents_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetEvents_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEvents(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetField_1 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetField_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetField(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetFields_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetFields_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetFields(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetMembers_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetMembers_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMembers(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetMethods_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethods_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethods(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetNestedType_1 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetNestedType_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetNestedType(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetNestedTypes_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetNestedTypes_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetNestedTypes(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetProperties_1 ($bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperties_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetProperties(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::InvokeMember_1 ($name, $invokeAttr, $binder, $target, $args, $modifiers, $culture, $namedParameters)
	 * @uses SignaturePointerTypeMethodsOverride::InvokeMember_2 ($name, $invokeAttr, $binder, $target, $args)
	 * @uses SignaturePointerTypeMethodsOverride::InvokeMember_3 ($name, $invokeAttr, $binder, $target, $args, $culture)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function InvokeMember(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetMethodImpl_1 ($name, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethodImpl_2 ($name, $genericParameterCount, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethodImpl(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetMember_1 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetMember_2 ($name, $type, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetMember_3 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMember(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetCustomAttributes_1 ($inherit)
	 * @uses SignaturePointerTypeMethodsOverride::GetCustomAttributes_2 ($attributeType, $inherit)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetCustomAttributes(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetInterface_1 ($name, $ignoreCase)
	 * @uses SignaturePointerTypeMethodsOverride::GetInterface_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetInterface(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetType_1 ()
	 * @uses SignaturePointerTypeMethodsOverride::GetType_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetType(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructor_1 ($types)
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructor_2 ($bindingAttr, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructor_3 ($bindingAttr, $binder, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetConstructor_4 ($bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetConstructor(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_1 ($name)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_2 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_3 ($name, $bindingAttr, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_4 ($name, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_5 ($name, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_6 ($name, $bindingAttr, $binder, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_7 ($name, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_8 ($name, $genericParameterCount, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_9 ($name, $genericParameterCount, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_10 ($name, $genericParameterCount, $bindingAttr, $binder, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetMethod_11 ($name, $genericParameterCount, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethod(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_1 ($name)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_2 ($name, $bindingAttr)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_3 ($name, $returnType)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_4 ($name, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_5 ($name, $returnType, $types)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_6 ($name, $returnType, $types, $modifiers)
	 * @uses SignaturePointerTypeMethodsOverride::GetProperty_7 ($name, $bindingAttr, $binder, $returnType, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetProperty(mixed ...$args){}
	/**
	 * @uses SignaturePointerTypeMethodsOverride::Equals_1 ($o)
	 * @uses SignaturePointerTypeMethodsOverride::Equals_2 ($o)
	 * @return mixed|@override
	 */

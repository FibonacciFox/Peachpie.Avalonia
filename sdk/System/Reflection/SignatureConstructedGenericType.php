 ...
 */
trait SignatureConstructedGenericTypeMethodsOverride
{
	/**
	 * @return \System\Type
	 */
...
/**
 */
class SignatureConstructedGenericType extends \System\Reflection\SignatureType implements 
	...
	\System\Reflection\IReflect
{
	...
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::MakeArrayType_1 ()
	 * @uses SignatureConstructedGenericTypeMethodsOverride::MakeArrayType_2 ($rank)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function MakeArrayType(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::get_Module_1 ()
	 * @uses SignatureConstructedGenericTypeMethodsOverride::get_Module_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Module(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructors_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructors_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetConstructors(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetEvent_1 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetEvent_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEvent(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetEvents_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetEvents_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEvents(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetField_1 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetField_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetField(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetFields_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetFields_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetFields(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMembers_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMembers_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMembers(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethods_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethods_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethods(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetNestedType_1 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetNestedType_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetNestedType(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetNestedTypes_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetNestedTypes_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetNestedTypes(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperties_1 ($bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperties_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetProperties(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::InvokeMember_1 ($name, $invokeAttr, $binder, $target, $args, $modifiers, $culture, $namedParameters)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::InvokeMember_2 ($name, $invokeAttr, $binder, $target, $args)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::InvokeMember_3 ($name, $invokeAttr, $binder, $target, $args, $culture)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function InvokeMember(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethodImpl_1 ($name, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethodImpl_2 ($name, $genericParameterCount, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethodImpl(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMember_1 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMember_2 ($name, $type, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMember_3 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMember(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetCustomAttributes_1 ($inherit)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetCustomAttributes_2 ($attributeType, $inherit)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetCustomAttributes(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetInterface_1 ($name, $ignoreCase)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetInterface_2 ($name)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetInterface(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetType_1 ()
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetType_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetType(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructor_1 ($types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructor_2 ($bindingAttr, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructor_3 ($bindingAttr, $binder, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetConstructor_4 ($bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetConstructor(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_1 ($name)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_2 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_3 ($name, $bindingAttr, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_4 ($name, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_5 ($name, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_6 ($name, $bindingAttr, $binder, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_7 ($name, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_8 ($name, $genericParameterCount, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_9 ($name, $genericParameterCount, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_10 ($name, $genericParameterCount, $bindingAttr, $binder, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetMethod_11 ($name, $genericParameterCount, $bindingAttr, $binder, $callConvention, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetMethod(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_1 ($name)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_2 ($name, $bindingAttr)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_3 ($name, $returnType)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_4 ($name, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_5 ($name, $returnType, $types)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_6 ($name, $returnType, $types, $modifiers)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::GetProperty_7 ($name, $bindingAttr, $binder, $returnType, $types, $modifiers)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetProperty(mixed ...$args){}
	/**
	 * @uses SignatureConstructedGenericTypeMethodsOverride::Equals_1 ($o)
	 * @uses SignatureConstructedGenericTypeMethodsOverride::Equals_2 ($o)
	 * @return mixed|@override
	 */

...
/**
 */
class TaskNode extends \System\Threading\Tasks\Task_1 implements 
	\System\IAsyncResult,
	\System\IDisposable
{
	/**
	...
	/**
	 * @uses TaskNodeMethodsOverride::TrySetResult_1 ($result)
	 * @uses TaskNodeMethodsOverride::TrySetResult_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function TrySetResult(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::GetAwaiter_1 ()
	 * @uses TaskNodeMethodsOverride::GetAwaiter_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetAwaiter(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::ConfigureAwait_1 ($continueOnCapturedContext)
	 * @uses TaskNodeMethodsOverride::ConfigureAwait_2 ($continueOnCapturedContext)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ConfigureAwait(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::WaitAsync_1 ($cancellationToken)
	 * @uses TaskNodeMethodsOverride::WaitAsync_2 ($timeout)
	 * @uses TaskNodeMethodsOverride::WaitAsync_3 ($timeout, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::WaitAsync_4 ($cancellationToken)
	 * @uses TaskNodeMethodsOverride::WaitAsync_5 ($timeout)
	 * @uses TaskNodeMethodsOverride::WaitAsync_6 ($timeout, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function WaitAsync(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::ContinueWith_1 ($continuationAction)
	 * @uses TaskNodeMethodsOverride::ContinueWith_2 ($continuationAction, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_3 ($continuationAction, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_4 ($continuationAction, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_5 ($continuationAction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_6 ($continuationAction, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_7 ($continuationAction, $state)
	 * @uses TaskNodeMethodsOverride::ContinueWith_8 ($continuationAction, $state, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_9 ($continuationAction, $state, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_10 ($continuationAction, $state, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_11 ($continuationAction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_12 ($continuationAction, $state, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_13 ($continuationFunction)
	 * @uses TaskNodeMethodsOverride::ContinueWith_14 ($continuationFunction, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_15 ($continuationFunction, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_16 ($continuationFunction, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_17 ($continuationFunction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_18 ($continuationFunction, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_19 ($continuationFunction, $state)
	 * @uses TaskNodeMethodsOverride::ContinueWith_20 ($continuationFunction, $state, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_21 ($continuationFunction, $state, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_22 ($continuationFunction, $state, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_23 ($continuationFunction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_24 ($continuationFunction, $state, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_25 ($continuationAction)
	 * @uses TaskNodeMethodsOverride::ContinueWith_26 ($continuationAction, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_27 ($continuationAction, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_28 ($continuationAction, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_29 ($continuationAction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_30 ($continuationAction, $state)
	 * @uses TaskNodeMethodsOverride::ContinueWith_31 ($continuationAction, $state, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_32 ($continuationAction, $state, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_33 ($continuationAction, $state, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_34 ($continuationAction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_35 ($continuationFunction)
	 * @uses TaskNodeMethodsOverride::ContinueWith_36 ($continuationFunction, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_37 ($continuationFunction, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_38 ($continuationFunction, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_39 ($continuationFunction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_40 ($continuationFunction, $state)
	 * @uses TaskNodeMethodsOverride::ContinueWith_41 ($continuationFunction, $state, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::ContinueWith_42 ($continuationFunction, $state, $scheduler)
	 * @uses TaskNodeMethodsOverride::ContinueWith_43 ($continuationFunction, $state, $continuationOptions)
	 * @uses TaskNodeMethodsOverride::ContinueWith_44 ($continuationFunction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ContinueWith(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::AtomicStateUpdate_1 ($newBits, $illegalBits)
	 * @uses TaskNodeMethodsOverride::AtomicStateUpdate_2 ($newBits, $illegalBits, $oldFlags)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function AtomicStateUpdate(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::Start_1 ()
	 * @uses TaskNodeMethodsOverride::Start_2 ($scheduler)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Start(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::RunSynchronously_1 ()
	 * @uses TaskNodeMethodsOverride::RunSynchronously_2 ($scheduler)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses TaskNodeMethodsOverride::Dispose_1 ()
	 * @uses TaskNodeMethodsOverride::Dispose_2 ($disposing)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Dispose(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::AddException_1 ($exceptionObject)
	 * @uses TaskNodeMethodsOverride::AddException_2 ($exceptionObject, $representsCancellation)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function AddException(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::Wait_1 ()
	 * @uses TaskNodeMethodsOverride::Wait_2 ($timeout)
	 * @uses TaskNodeMethodsOverride::Wait_3 ($timeout, $cancellationToken)
	 * @uses TaskNodeMethodsOverride::Wait_4 ($cancellationToken)
	 * @uses TaskNodeMethodsOverride::Wait_5 ($millisecondsTimeout)
	 * @uses TaskNodeMethodsOverride::Wait_6 ($millisecondsTimeout, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Wait(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::RecordInternalCancellationRequest_1 ()
	 * @uses TaskNodeMethodsOverride::RecordInternalCancellationRequest_2 ($tokenToRecord, $cancellationException)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function RecordInternalCancellationRequest(mixed ...$args){}
	/**
	 * @uses TaskNodeMethodsOverride::TrySetCanceled_1 ($tokenToRecord)
	 * @uses TaskNodeMethodsOverride::TrySetCanceled_2 ($tokenToRecord, $cancellationException)
	 * @return mixed|@override
	 */

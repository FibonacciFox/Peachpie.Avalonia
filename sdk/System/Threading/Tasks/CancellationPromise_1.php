 ...
 */
trait CancellationPromise_1MethodsOverride
{
	/**
 ...
 * @deprecated this element should not be used by you because it will break your program
 */
class CancellationPromise_1 extends \System\Threading\Tasks\Task_1 implements 
	\System\IAsyncResult,
	\System\IDisposable,
	\System\Threading\Tasks\ITaskCompletionAction
{
	...
	/**
	 * @uses CancellationPromise_1MethodsOverride::TrySetResult_1 ($result)
	 * @uses CancellationPromise_1MethodsOverride::TrySetResult_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function TrySetResult(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::GetAwaiter_1 ()
	 * @uses CancellationPromise_1MethodsOverride::GetAwaiter_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetAwaiter(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::ConfigureAwait_1 ($continueOnCapturedContext)
	 * @uses CancellationPromise_1MethodsOverride::ConfigureAwait_2 ($continueOnCapturedContext)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ConfigureAwait(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_1 ($cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_2 ($timeout)
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_3 ($timeout, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_4 ($cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_5 ($timeout)
	 * @uses CancellationPromise_1MethodsOverride::WaitAsync_6 ($timeout, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function WaitAsync(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_1 ($continuationAction)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_2 ($continuationAction, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_3 ($continuationAction, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_4 ($continuationAction, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_5 ($continuationAction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_6 ($continuationAction, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_7 ($continuationAction, $state)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_8 ($continuationAction, $state, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_9 ($continuationAction, $state, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_10 ($continuationAction, $state, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_11 ($continuationAction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_12 ($continuationAction, $state, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_13 ($continuationFunction)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_14 ($continuationFunction, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_15 ($continuationFunction, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_16 ($continuationFunction, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_17 ($continuationFunction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_18 ($continuationFunction, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_19 ($continuationFunction, $state)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_20 ($continuationFunction, $state, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_21 ($continuationFunction, $state, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_22 ($continuationFunction, $state, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_23 ($continuationFunction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_24 ($continuationFunction, $state, $scheduler, $cancellationToken, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_25 ($continuationAction)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_26 ($continuationAction, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_27 ($continuationAction, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_28 ($continuationAction, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_29 ($continuationAction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_30 ($continuationAction, $state)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_31 ($continuationAction, $state, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_32 ($continuationAction, $state, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_33 ($continuationAction, $state, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_34 ($continuationAction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_35 ($continuationFunction)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_36 ($continuationFunction, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_37 ($continuationFunction, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_38 ($continuationFunction, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_39 ($continuationFunction, $cancellationToken, $continuationOptions, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_40 ($continuationFunction, $state)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_41 ($continuationFunction, $state, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_42 ($continuationFunction, $state, $scheduler)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_43 ($continuationFunction, $state, $continuationOptions)
	 * @uses CancellationPromise_1MethodsOverride::ContinueWith_44 ($continuationFunction, $state, $cancellationToken, $continuationOptions, $scheduler)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ContinueWith(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::AtomicStateUpdate_1 ($newBits, $illegalBits)
	 * @uses CancellationPromise_1MethodsOverride::AtomicStateUpdate_2 ($newBits, $illegalBits, $oldFlags)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function AtomicStateUpdate(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::Start_1 ()
	 * @uses CancellationPromise_1MethodsOverride::Start_2 ($scheduler)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Start(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::RunSynchronously_1 ()
	 * @uses CancellationPromise_1MethodsOverride::RunSynchronously_2 ($scheduler)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses CancellationPromise_1MethodsOverride::Dispose_1 ()
	 * @uses CancellationPromise_1MethodsOverride::Dispose_2 ($disposing)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Dispose(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::AddException_1 ($exceptionObject)
	 * @uses CancellationPromise_1MethodsOverride::AddException_2 ($exceptionObject, $representsCancellation)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function AddException(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::Wait_1 ()
	 * @uses CancellationPromise_1MethodsOverride::Wait_2 ($timeout)
	 * @uses CancellationPromise_1MethodsOverride::Wait_3 ($timeout, $cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::Wait_4 ($cancellationToken)
	 * @uses CancellationPromise_1MethodsOverride::Wait_5 ($millisecondsTimeout)
	 * @uses CancellationPromise_1MethodsOverride::Wait_6 ($millisecondsTimeout, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Wait(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::RecordInternalCancellationRequest_1 ()
	 * @uses CancellationPromise_1MethodsOverride::RecordInternalCancellationRequest_2 ($tokenToRecord, $cancellationException)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function RecordInternalCancellationRequest(mixed ...$args){}
	/**
	 * @uses CancellationPromise_1MethodsOverride::TrySetCanceled_1 ($tokenToRecord)
	 * @uses CancellationPromise_1MethodsOverride::TrySetCanceled_2 ($tokenToRecord, $cancellationException)
	 * @return mixed|@override
	 */

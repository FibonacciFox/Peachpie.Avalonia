...
/**
 */
class UInt32 extends \System\ValueType implements 
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	public $MinValue;
	/**
	 * @uses UInt32MethodsOverride::CompareTo_1 ($value)
	 * @uses UInt32MethodsOverride::CompareTo_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CompareTo(mixed ...$args){}
	/**
	 * @uses UInt32MethodsOverride::Equals_1 ($obj)
	 * @uses UInt32MethodsOverride::Equals_2 ($obj)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Equals(mixed ...$args){}
	/**
	 * @uses UInt32MethodsOverride::ToString_1 ()
	 * @uses UInt32MethodsOverride::ToString_2 ($provider)
	 * @uses UInt32MethodsOverride::ToString_3 ($format)
	 * @uses UInt32MethodsOverride::ToString_4 ($format, $provider)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses UInt32MethodsOverride::Parse_1 ($s)
	 * @uses UInt32MethodsOverride::Parse_2 ($s, $style)
	 * @uses UInt32MethodsOverride::Parse_3 ($s, $provider)
	 * @uses UInt32MethodsOverride::Parse_4 ($s, $style, $provider)
	 * @uses UInt32MethodsOverride::Parse_5 ($s, $style, $provider)
	 * @uses UInt32MethodsOverride::Parse_6 ($s, $provider)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function Parse(mixed ...$args){}
	/**
	 * @uses UInt32MethodsOverride::TryParse_1 ($s, $result)
	 * @uses UInt32MethodsOverride::TryParse_2 ($s, $result)
	 * @uses UInt32MethodsOverride::TryParse_3 ($s, $style, $provider, $result)
	 * @uses UInt32MethodsOverride::TryParse_4 ($s, $style, $provider, $result)
	 * @uses UInt32MethodsOverride::TryParse_5 ($s, $provider, $result)
	 * @uses UInt32MethodsOverride::TryParse_6 ($s, $provider, $result)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses UInt32MethodsOverride::TryConvertFromChecked_1 ($value, $result)
	 * @uses UInt32MethodsOverride::TryConvertFromChecked_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromChecked(mixed ...$args){}
	/**
	 * @uses UInt32MethodsOverride::TryConvertFromSaturating_1 ($value, $result)
	 * @uses UInt32MethodsOverride::TryConvertFromSaturating_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromSaturating(mixed ...$args){}
	/**
	 * @uses UInt32MethodsOverride::TryConvertFromTruncating_1 ($value, $result)
	 * @uses UInt32MethodsOverride::TryConvertFromTruncating_2 ($value, $result)
	 * @return mixed|@override
	 */

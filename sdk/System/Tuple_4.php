	...
	\System\Runtime\CompilerServices\ITuple
{
	...
	/**
	 * @uses Tuple_4MethodsOverride::Equals_1 ($obj)
	 * @uses Tuple_4MethodsOverride::Equals_2 ($other, $comparer)
	 * @uses Tuple_4MethodsOverride::Equals_3 ($other, $comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Equals(mixed ...$args){}
	/**
	 * @uses Tuple_4MethodsOverride::CompareTo_1 ($obj)
	 * @uses Tuple_4MethodsOverride::CompareTo_2 ($other, $comparer)
	 * @uses Tuple_4MethodsOverride::CompareTo_3 ($other, $comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CompareTo(mixed ...$args){}
	/**
	 * @uses Tuple_4MethodsOverride::GetHashCode_1 ()
	 * @uses Tuple_4MethodsOverride::GetHashCode_2 ($comparer)
	 * @uses Tuple_4MethodsOverride::GetHashCode_3 ($comparer)
	 * @uses Tuple_4MethodsOverride::GetHashCode_4 ($comparer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetHashCode(mixed ...$args){}
	/**
	 * @uses Tuple_4MethodsOverride::ToString_1 ()
	 * @uses Tuple_4MethodsOverride::ToString_2 ($sb)
	 * @uses Tuple_4MethodsOverride::ToString_3 ($sb)
	 * @return mixed|@override
	 */

...
/**
 */
class Int64 extends \System\ValueType implements 
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\ISignedNumber_1
{
	...
	public $MinValue;
	/**
	 * @uses Int64MethodsOverride::CompareTo_1 ($value)
	 * @uses Int64MethodsOverride::CompareTo_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CompareTo(mixed ...$args){}
	/**
	 * @uses Int64MethodsOverride::Equals_1 ($obj)
	 * @uses Int64MethodsOverride::Equals_2 ($obj)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Equals(mixed ...$args){}
	/**
	 * @uses Int64MethodsOverride::ToString_1 ()
	 * @uses Int64MethodsOverride::ToString_2 ($provider)
	 * @uses Int64MethodsOverride::ToString_3 ($format)
	 * @uses Int64MethodsOverride::ToString_4 ($format, $provider)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses Int64MethodsOverride::Parse_1 ($s)
	 * @uses Int64MethodsOverride::Parse_2 ($s, $style)
	 * @uses Int64MethodsOverride::Parse_3 ($s, $provider)
	 * @uses Int64MethodsOverride::Parse_4 ($s, $style, $provider)
	 * @uses Int64MethodsOverride::Parse_5 ($s, $style, $provider)
	 * @uses Int64MethodsOverride::Parse_6 ($s, $provider)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function Parse(mixed ...$args){}
	/**
	 * @uses Int64MethodsOverride::TryParse_1 ($s, $result)
	 * @uses Int64MethodsOverride::TryParse_2 ($s, $result)
	 * @uses Int64MethodsOverride::TryParse_3 ($s, $style, $provider, $result)
	 * @uses Int64MethodsOverride::TryParse_4 ($s, $style, $provider, $result)
	 * @uses Int64MethodsOverride::TryParse_5 ($s, $provider, $result)
	 * @uses Int64MethodsOverride::TryParse_6 ($s, $provider, $result)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses Int64MethodsOverride::TryConvertFromChecked_1 ($value, $result)
	 * @uses Int64MethodsOverride::TryConvertFromChecked_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromChecked(mixed ...$args){}
	/**
	 * @uses Int64MethodsOverride::TryConvertFromSaturating_1 ($value, $result)
	 * @uses Int64MethodsOverride::TryConvertFromSaturating_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromSaturating(mixed ...$args){}
	/**
	 * @uses Int64MethodsOverride::TryConvertFromTruncating_1 ($value, $result)
	 * @uses Int64MethodsOverride::TryConvertFromTruncating_2 ($value, $result)
	 * @return mixed|@override
	 */

...
/**
 */
class UInt64 extends \System\ValueType implements 
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	public $MinValue;
	/**
	 * @uses UInt64MethodsOverride::CompareTo_1 ($value)
	 * @uses UInt64MethodsOverride::CompareTo_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CompareTo(mixed ...$args){}
	/**
	 * @uses UInt64MethodsOverride::Equals_1 ($obj)
	 * @uses UInt64MethodsOverride::Equals_2 ($obj)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Equals(mixed ...$args){}
	/**
	 * @uses UInt64MethodsOverride::ToString_1 ()
	 * @uses UInt64MethodsOverride::ToString_2 ($provider)
	 * @uses UInt64MethodsOverride::ToString_3 ($format)
	 * @uses UInt64MethodsOverride::ToString_4 ($format, $provider)
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses UInt64MethodsOverride::Parse_1 ($s)
	 * @uses UInt64MethodsOverride::Parse_2 ($s, $style)
	 * @uses UInt64MethodsOverride::Parse_3 ($s, $provider)
	 * @uses UInt64MethodsOverride::Parse_4 ($s, $style, $provider)
	 * @uses UInt64MethodsOverride::Parse_5 ($s, $style, $provider)
	 * @uses UInt64MethodsOverride::Parse_6 ($s, $provider)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function Parse(mixed ...$args){}
	/**
	 * @uses UInt64MethodsOverride::TryParse_1 ($s, $result)
	 * @uses UInt64MethodsOverride::TryParse_2 ($s, $result)
	 * @uses UInt64MethodsOverride::TryParse_3 ($s, $style, $provider, $result)
	 * @uses UInt64MethodsOverride::TryParse_4 ($s, $style, $provider, $result)
	 * @uses UInt64MethodsOverride::TryParse_5 ($s, $provider, $result)
	 * @uses UInt64MethodsOverride::TryParse_6 ($s, $provider, $result)
	 * @return mixed|@override
	 */
	...
	/**
	 * @param \System\UInt64 $value
	 * @param \System\UInt64 $sign
	 * @deprecated this element should not be used by you because it will break your program
	 * @return @deprecated
	 */
	#[MethodPrivate] static function CopySign($value, $sign){}
	/**
	 * @param \System\UInt64 $x
	 * @param \System\UInt64 $y
	 * @return \System\UInt64
	 */
	...
	/**
	 * @uses UInt64MethodsOverride::TryConvertFromChecked_1 ($value, $result)
	 * @uses UInt64MethodsOverride::TryConvertFromChecked_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromChecked(mixed ...$args){}
	/**
	 * @uses UInt64MethodsOverride::TryConvertFromSaturating_1 ($value, $result)
	 * @uses UInt64MethodsOverride::TryConvertFromSaturating_2 ($value, $result)
	 * @return mixed|@override
	 */
	#[MethodOverride] static function TryConvertFromSaturating(mixed ...$args){}
	/**
	 * @uses UInt64MethodsOverride::TryConvertFromTruncating_1 ($value, $result)
	 * @uses UInt64MethodsOverride::TryConvertFromTruncating_2 ($value, $result)
	 * @return mixed|@override
	 */

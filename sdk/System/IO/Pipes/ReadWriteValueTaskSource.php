 ...
 */
trait ReadWriteValueTaskSourceMethodsOverride
{
	/**
...
/**
 */
class ReadWriteValueTaskSource extends \System\IO\Pipes\PipeValueTaskSource implements 
	...
	\System\Threading\Tasks\Sources\IValueTaskSource
{
	...
	protected $_result;
	/**
	 * @uses ReadWriteValueTaskSourceMethodsOverride::GetResult_1 ($token)
	 * @uses ReadWriteValueTaskSourceMethodsOverride::GetResult_2 ($token)

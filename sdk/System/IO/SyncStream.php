 ...
 */
trait SyncStreamMethodsOverride
{
	/**
	 ...
	 */
	#[MethodOverride] public  function Read_1($bytes, $offset, $count){}
	/**
	 * @return \System\Int32|int
	 */
	 ...
	 * @return \System\Void|void
	 */
	#[MethodOverride] public  function Write_1($bytes, $offset, $count){}
	/**
	 * @return \System\Void|void
	 */
...
/**
 */
class SyncStream extends \System\IO\Stream implements 
	\System\IDisposable,
	\System\IAsyncDisposable
{
	...
	public $WriteTimeout;
	/**
	 * @uses SyncStreamMethodsOverride::Dispose_1 ($disposing)
	 * @uses SyncStreamMethodsOverride::Dispose_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Dispose(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::Read_1 ($bytes, $offset, $count)
	 * @uses SyncStreamMethodsOverride::Read_2 ($buffer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Read(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::Write_1 ($bytes, $offset, $count)
	 * @uses SyncStreamMethodsOverride::Write_2 ($buffer)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Write(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::CopyTo_1 ($destination)
	 * @uses SyncStreamMethodsOverride::CopyTo_2 ($destination, $bufferSize)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::CopyToAsync_1 ($destination)
	 * @uses SyncStreamMethodsOverride::CopyToAsync_2 ($destination, $bufferSize)
	 * @uses SyncStreamMethodsOverride::CopyToAsync_3 ($destination, $cancellationToken)
	 * @uses SyncStreamMethodsOverride::CopyToAsync_4 ($destination, $bufferSize, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyToAsync(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::FlushAsync_1 ()
	 * @uses SyncStreamMethodsOverride::FlushAsync_2 ($cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function FlushAsync(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::ReadAsync_1 ($buffer, $offset, $count)
	 * @uses SyncStreamMethodsOverride::ReadAsync_2 ($buffer, $offset, $count, $cancellationToken)
	 * @uses SyncStreamMethodsOverride::ReadAsync_3 ($buffer, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ReadAsync(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::ReadExactlyAsync_1 ($buffer, $cancellationToken)
	 * @uses SyncStreamMethodsOverride::ReadExactlyAsync_2 ($buffer, $offset, $count, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ReadExactlyAsync(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::WriteAsync_1 ($buffer, $offset, $count)
	 * @uses SyncStreamMethodsOverride::WriteAsync_2 ($buffer, $offset, $count, $cancellationToken)
	 * @uses SyncStreamMethodsOverride::WriteAsync_3 ($buffer, $cancellationToken)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function WriteAsync(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::ReadExactly_1 ($buffer)
	 * @uses SyncStreamMethodsOverride::ReadExactly_2 ($buffer, $offset, $count)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function ReadExactly(mixed ...$args){}
	/**
	 * @uses SyncStreamMethodsOverride::MemberwiseClone_1 ($cloneIdentity)
	 * @uses SyncStreamMethodsOverride::MemberwiseClone_2 ()
	 * @return mixed|@override
	 */

 ...
 */
trait DrawingCollectionMethodsOverride
{
	/**
...
/**
 */
class DrawingCollection extends \Avalonia\Collections\AvaloniaList_1 implements 
...
{
	/**
	 * @uses DrawingCollectionMethodsOverride::get_Count_1 ()
	 * @uses DrawingCollectionMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses DrawingCollectionMethodsOverride::get_IsReadOnly_1 ()
	 * @uses DrawingCollectionMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses DrawingCollectionMethodsOverride::get_Item_1 ($index)
	 * @uses DrawingCollectionMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::set_Item_1 ($index, $value)
	 * @uses DrawingCollectionMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::Add_1 ($item)
	 * @uses DrawingCollectionMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::Clear_1 ()
	 * @uses DrawingCollectionMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::Contains_1 ($item)
	 * @uses DrawingCollectionMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses DrawingCollectionMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::GetEnumerator_1 ()
	 * @uses DrawingCollectionMethodsOverride::GetEnumerator_2 ()
	 * @uses DrawingCollectionMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::IndexOf_1 ($item)
	 * @uses DrawingCollectionMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::Insert_1 ($index, $item)
	 * @uses DrawingCollectionMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::Remove_1 ($item)
	 * @uses DrawingCollectionMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses DrawingCollectionMethodsOverride::RemoveAt_1 ($index)
	 * @uses DrawingCollectionMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

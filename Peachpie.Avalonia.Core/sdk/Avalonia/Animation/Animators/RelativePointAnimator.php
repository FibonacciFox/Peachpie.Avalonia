 ...
 */
trait RelativePointAnimatorMethodsOverride
{
	/**
...
/**
 */
class RelativePointAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses RelativePointAnimatorMethodsOverride::get_Count_1 ()
	 * @uses RelativePointAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses RelativePointAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses RelativePointAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses RelativePointAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses RelativePointAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses RelativePointAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::Add_1 ($item)
	 * @uses RelativePointAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::Clear_1 ()
	 * @uses RelativePointAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses RelativePointAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses RelativePointAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses RelativePointAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses RelativePointAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses RelativePointAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses RelativePointAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses RelativePointAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses RelativePointAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses RelativePointAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

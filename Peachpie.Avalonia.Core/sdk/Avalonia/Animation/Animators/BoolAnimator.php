 ...
 */
trait BoolAnimatorMethodsOverride
{
	/**
...
/**
 */
class BoolAnimator extends \Avalonia\Animation\Animators\Animator_1 implements 
...
{
	/**
	 * @uses BoolAnimatorMethodsOverride::get_Count_1 ()
	 * @uses BoolAnimatorMethodsOverride::get_Count_2 ()
	...
	/**
	 * @uses BoolAnimatorMethodsOverride::get_IsReadOnly_1 ()
	 * @uses BoolAnimatorMethodsOverride::get_IsReadOnly_2 ()
	 * @return mixed|@override
	 */
	...
	/**
	 * @uses BoolAnimatorMethodsOverride::get_Item_1 ($index)
	 * @uses BoolAnimatorMethodsOverride::get_Item_2 ($index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function get_Item(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::set_Item_1 ($index, $value)
	 * @uses BoolAnimatorMethodsOverride::set_Item_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function set_Item(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::Add_1 ($item)
	 * @uses BoolAnimatorMethodsOverride::Add_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Add(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::Clear_1 ()
	 * @uses BoolAnimatorMethodsOverride::Clear_2 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Clear(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::Contains_1 ($item)
	 * @uses BoolAnimatorMethodsOverride::Contains_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Contains(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::CopyTo_1 ($array, $arrayIndex)
	 * @uses BoolAnimatorMethodsOverride::CopyTo_2 ($array, $index)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function CopyTo(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::GetEnumerator_1 ()
	 * @uses BoolAnimatorMethodsOverride::GetEnumerator_2 ()
	 * @uses BoolAnimatorMethodsOverride::GetEnumerator_3 ()
	 * @return mixed|@override
	 */
	#[MethodOverride]  function GetEnumerator(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::IndexOf_1 ($item)
	 * @uses BoolAnimatorMethodsOverride::IndexOf_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function IndexOf(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::Insert_1 ($index, $item)
	 * @uses BoolAnimatorMethodsOverride::Insert_2 ($index, $value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Insert(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::Remove_1 ($item)
	 * @uses BoolAnimatorMethodsOverride::Remove_2 ($value)
	 * @return mixed|@override
	 */
	#[MethodOverride]  function Remove(mixed ...$args){}
	/**
	 * @uses BoolAnimatorMethodsOverride::RemoveAt_1 ($index)
	 * @uses BoolAnimatorMethodsOverride::RemoveAt_2 ($index)
	 * @return mixed|@override
	 */

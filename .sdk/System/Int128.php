...
final class Int128 extends \System\ValueType implements
	...
	\System\Numerics\ISignedNumber_1
{
	...
	public $NegativeOne;
	/**
	 * @uses Int128Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses Int128Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses Int128Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses Int128Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses Int128Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses Int128Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int128Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int128Override::Parse_6 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int128|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses Int128Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses Int128Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses Int128Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int128Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int128Override::TryParse_5 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses Int128Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	#[MethodOverridePublic]function TryParse (\override ...$args){}
	/**
	 * @uses Int128Override::op_Explicit_1 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_2 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_3 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_4 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_5 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_6 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_7 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_8 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_9 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_10 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_11 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_12 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_13 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_14 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_15 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_16 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_17 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_18 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Explicit_19 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Byte|\System\Char|\System\Decimal|\System\Double|double|\System\Half|\System\Int16|\System\Int32|int|\System\Int64|int|\System\IntPtr|\System\SByte|\System\Single|\System\UInt16|\System\UInt32|\System\UInt64|\System\UInt128|\System\UIntPtr|\System\Int128|mixed|\override
	 */
	#[MethodOverridePublic]function op_Explicit (\override ...$args){}
	/**
	 * @uses Int128Override::op_CheckedExplicit_1 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_2 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_3 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_4 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_5 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_6 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_7 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_8 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_9 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_10 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_11 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_12 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_13 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_CheckedExplicit_14 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Byte|\System\Char|\System\Int16|\System\Int32|int|\System\Int64|int|\System\IntPtr|\System\SByte|\System\UInt16|\System\UInt32|\System\UInt64|\System\UInt128|\System\UIntPtr|\System\Int128|mixed|\override
	 */
	 ...
	 * @return \System\Int128
	 */
	protected static function ToInt128($value){}
	/**
	 * @uses Int128Override::op_Implicit_1 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_2 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_3 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_4 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_5 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_6 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_7 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_8 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_9 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_10 <br>public , args: ($value)<br>
	 * @uses Int128Override::op_Implicit_11 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int128|mixed|\override
	 */
	#[MethodOverridePublic]function op_Implicit (\override ...$args){}
	/**
	 * @param \System\Int128 $left
	 * @param \System\Int128 $right
	 * @return \System\Int128
	 */
	 ...
	 * @param \System\Int128 $left
	 * @param \System\Int128 $right
	 * @return \System\ValueTuple_2[System\Int128,System\Int128]
	 */
	 ...
	 * @param \System\Int128 $left
	 * @param \System\Int128 $right
	 * @param \System\Int128& &$lower
	 * @return \System\Int128
	 */
	protected static function BigMul($left, $right, &$lower){}
	/**
	 * @param \System\Int128 $value
	 * @param \System\Int128 $min
	 * @param \System\Int128 $max
	 * @return \System\Int128
	 */
	public static function Clamp($value, $min, $max){}
	/**
	 * @param \System\Int128 $value
	 * @param \System\Int128 $sign
	 * @return \System\Int128
	 */
	public static function CopySign($value, $sign){}
	/**
	 * @param \System\Int128 $x
	 * @param \System\Int128 $y
	 * @return \System\Int128
	 */
	 ...
	 * @uses Int128Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int128Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int128Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int128Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int128Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int128Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

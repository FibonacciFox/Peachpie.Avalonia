...
trait ValueTuple_7Override {
	...
	/**
	 * @deprecated
	 * @param \System\ValueTuple_7 $other [generic: T1,T2,T3,T4,T5,T6,T7]
	 * @return \System\Int32|int
	 */
...
final class ValueTuple_7 extends \System\ValueType implements
	\System\IEquatable_1,
	...
	\System\Runtime\CompilerServices\ITuple
{
	...
	public $Item7;
	/**
	 * @uses ValueTuple_7Override::CompareTo_1 <br>private , args: ($other)<br>
	 * @uses ValueTuple_7Override::CompareTo_2 <br>public , args: ($other)<br>
	 * @uses ValueTuple_7Override::CompareTo_3 <br>private , args: ($other, $comparer)<br>
	 ...
	 * @uses ValueTuple_7Override::GetHashCode_1 <br>private , args: ($comparer)<br>
	 * @uses ValueTuple_7Override::GetHashCode_2 <br>private , args: ($comparer)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */

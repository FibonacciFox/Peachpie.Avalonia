...
final class Int16 extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\ISignedNumber_1
{
	...
	/**
	 * @uses Int16Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses Int16Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses Int16Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses Int16Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses Int16Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses Int16Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int16Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int16Override::Parse_6 <br>private , args: ($s, $style, $info)<br>
	 * @uses Int16Override::Parse_7 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int16|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses Int16Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses Int16Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses Int16Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int16Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int16Override::TryParse_5 <br>private , args: ($s, $style, $info, &$result)<br>
	 * @uses Int16Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses Int16Override::TryParse_7 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\Int16,System\Int16]
	 */
	 ...
	 * @uses Int16Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int16Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int16Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int16Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int16Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int16Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

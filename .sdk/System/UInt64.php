...
final class UInt64 extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	const MinValue = '0';
	/**
	 * @uses UInt64Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses UInt64Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses UInt64Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses UInt64Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses UInt64Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses UInt64Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt64Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt64Override::Parse_6 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\UInt64|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses UInt64Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses UInt64Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses UInt64Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt64Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt64Override::TryParse_5 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses UInt64Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\UInt64,System\UInt64]
	 */
	 ...
	 * @uses UInt64Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt64Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt64Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt64Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt64Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt64Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

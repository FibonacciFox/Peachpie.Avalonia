...
*/
trait NFloatOverride {
	/**
	 * @deprecated
	 * @param \System\Decimal $value
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	...
	/**
	 * @deprecated
	 * @param \System\Runtime\InteropServices\NFloat $value
	 * @return \System\Byte
	 */
	 ...
	 */
	#[MethodOverride]public static function op_Implicit_14 ($value){}
	/**
	 * @deprecated
	 ...
	 * @deprecated
	 * @param \System\String|string $s
	 * @param \System\Runtime\InteropServices\NFloat& &$result
	...
	/**
	 * @deprecated
	 * @param \System\Runtime\InteropServices\NFloat $other
	 * @return \System\Int32|int
	 */
	#[MethodOverride]public function CompareTo_2 ($other){}
	/**
	 * @deprecated
	 * @param \System\Runtime\InteropServices\NFloat $x
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	 ...
	 * @deprecated
	 * @param \System\Runtime\InteropServices\NFloat $x
	 * @param \System\Runtime\InteropServices\NFloat $newBase
	 * @return \System\Runtime\InteropServices\NFloat
	 */
...
final class NFloat extends \System\ValueType implements
	...
	\System\Numerics\IMinMaxValue_1
{
	...
	/**
	 * @property
	 * @var \System\Runtime\InteropServices\NFloat
	 * @since readonly
	 */
	public $Epsilon;
	/**
	...
	/**
	 * @param \System\Runtime\InteropServices\NFloat $left
	 * @param \System\Runtime\InteropServices\NFloat $right
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	...
	/**
	 * @uses NFloatOverride::op_Explicit_1 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_2 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_3 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_4 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_5 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_6 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_7 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_8 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_9 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_10 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_11 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_12 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_13 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_14 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_15 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_16 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_17 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_18 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_19 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Explicit_20 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Runtime\InteropServices\NFloat|\System\Byte|\System\Char|\System\Decimal|\System\Half|\System\Int16|\System\Int32|int|\System\Int64|int|\System\Int128|\System\IntPtr|\System\SByte|\System\Single|\System\UInt16|\System\UInt32|\System\UInt64|\System\UInt128|\System\UIntPtr|mixed|\override
	 */
	#[MethodOverridePublic]function op_Explicit (\override ...$args){}
	/**
	 * @uses NFloatOverride::op_CheckedExplicit_1 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_2 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_3 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_4 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_5 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_6 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_7 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_8 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_9 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_10 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_11 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_12 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_CheckedExplicit_13 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	...
	/**
	 * @uses NFloatOverride::op_Implicit_1 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_2 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_3 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_4 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_5 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_6 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_7 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_8 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_9 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_10 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_11 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_12 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_13 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::op_Implicit_14 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Runtime\InteropServices\NFloat|\System\Double|double|mixed|\override
	 */
	...
	/**
	 * @uses NFloatOverride::Parse_1 <br>public , args: ($s)<br>
	 * @uses NFloatOverride::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses NFloatOverride::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses NFloatOverride::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses NFloatOverride::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses NFloatOverride::Parse_6 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Runtime\InteropServices\NFloat|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses NFloatOverride::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses NFloatOverride::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses NFloatOverride::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses NFloatOverride::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses NFloatOverride::TryParse_5 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses NFloatOverride::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	#[MethodOverridePublic]function TryParse (\override ...$args){}
	/**
	 * @uses NFloatOverride::CompareTo_1 <br>public , args: ($obj)<br>
	 * @uses NFloatOverride::CompareTo_2 <br>public , args: ($other)<br>
	 * @var mixed|\override ...$args
	...
	/**
	 * @uses NFloatOverride::Round_1 <br>public , args: ($x)<br>
	 * @uses NFloatOverride::Round_2 <br>public , args: ($x, $digits)<br>
	 * @uses NFloatOverride::Round_3 <br>public , args: ($x, $mode)<br>
	 * @uses NFloatOverride::Round_4 <br>public , args: ($x, $digits, $mode)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Runtime\InteropServices\NFloat|mixed|\override
	 */
	...
	/**
	 * @param \System\Runtime\InteropServices\NFloat $y
	 * @param \System\Runtime\InteropServices\NFloat $x
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	 ...
	 * @param \System\Runtime\InteropServices\NFloat $left
	 * @param \System\Runtime\InteropServices\NFloat $right
	 * @param \System\Runtime\InteropServices\NFloat $addend
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	...
	/**
	 * @uses NFloatOverride::Log_1 <br>public , args: ($x)<br>
	 * @uses NFloatOverride::Log_2 <br>public , args: ($x, $newBase)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Runtime\InteropServices\NFloat|mixed|\override
	 */
	...
	/**
	 * @param \System\Runtime\InteropServices\NFloat $value
	 * @param \System\Runtime\InteropServices\NFloat $min
	 * @param \System\Runtime\InteropServices\NFloat $max
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	public static function Clamp($value, $min, $max){}
	/**
	 * @param \System\Runtime\InteropServices\NFloat $value
	 * @param \System\Runtime\InteropServices\NFloat $sign
	 * @return \System\Runtime\InteropServices\NFloat
	 */
	...
	/**
	 * @param \System\Runtime\InteropServices\NFloat $x
	 * @return \System\ValueTuple_2[System\Runtime\InteropServices\NFloat,System\Runtime\InteropServices\NFloat]
	 */
	...
	/**
	 * @uses NFloatOverride::__construct_1 <br>public , args: ($value)<br>
	 * @uses NFloatOverride::__construct_2 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	*/

...
final class SByte extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\ISignedNumber_1
{
	...
	const MinValue = '-128';
	/**
	 * @uses SByteOverride::CompareTo_1 <br>public , args: ($obj)<br>
	 * @uses SByteOverride::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses SByteOverride::Parse_1 <br>public , args: ($s)<br>
	 * @uses SByteOverride::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses SByteOverride::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses SByteOverride::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses SByteOverride::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses SByteOverride::Parse_6 <br>private , args: ($s, $style, $info)<br>
	 * @uses SByteOverride::Parse_7 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\SByte|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses SByteOverride::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses SByteOverride::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses SByteOverride::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses SByteOverride::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses SByteOverride::TryParse_5 <br>private , args: ($s, $style, $info, &$result)<br>
	 * @uses SByteOverride::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses SByteOverride::TryParse_7 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\SByte,System\SByte]
	 */
	 ...
	 * @uses SByteOverride::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses SByteOverride::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses SByteOverride::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses SByteOverride::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses SByteOverride::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses SByteOverride::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

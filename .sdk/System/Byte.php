...
final class Byte extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	const MinValue = '0';
	/**
	 * @uses ByteOverride::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses ByteOverride::CompareTo_2 <br>public , args: ($value)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */
	#[MethodOverridePublic]function CompareTo (\override ...$args){}
	/**
	 * @uses ByteOverride::Parse_1 <br>public , args: ($s)<br>
	 * @uses ByteOverride::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses ByteOverride::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses ByteOverride::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses ByteOverride::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses ByteOverride::Parse_6 <br>private , args: ($s, $style, $info)<br>
	 * @uses ByteOverride::Parse_7 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Byte|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses ByteOverride::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses ByteOverride::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses ByteOverride::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses ByteOverride::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses ByteOverride::TryParse_5 <br>private , args: ($s, $style, $info, &$result)<br>
	 * @uses ByteOverride::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses ByteOverride::TryParse_7 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\Byte,System\Byte]
	 */
	 ...
	 * @uses ByteOverride::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses ByteOverride::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses ByteOverride::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses ByteOverride::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses ByteOverride::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses ByteOverride::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

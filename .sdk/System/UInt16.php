...
final class UInt16 extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\IUnsignedNumber_1
{
	...
	const MinValue = '0';
	/**
	 * @uses UInt16Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses UInt16Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses UInt16Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses UInt16Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses UInt16Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses UInt16Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt16Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses UInt16Override::Parse_6 <br>private , args: ($s, $style, $info)<br>
	 * @uses UInt16Override::Parse_7 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\UInt16|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses UInt16Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses UInt16Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses UInt16Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt16Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses UInt16Override::TryParse_5 <br>private , args: ($s, $style, $info, &$result)<br>
	 * @uses UInt16Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses UInt16Override::TryParse_7 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @return \System\ValueTuple_2[System\UInt16,System\UInt16]
	 */
	 ...
	 * @uses UInt16Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt16Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt16Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt16Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses UInt16Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses UInt16Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

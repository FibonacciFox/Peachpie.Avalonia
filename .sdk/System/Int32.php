...
final class Int32 extends \System\ValueType implements
	\System\IComparable,
	\System\IConvertible,
	...
	\System\Numerics\ISignedNumber_1
{
	...
	/**
	 * @uses Int32Override::CompareTo_1 <br>public , args: ($value)<br>
	 * @uses Int32Override::CompareTo_2 <br>public , args: ($value)<br>
	...
	/**
	 * @uses Int32Override::Parse_1 <br>public , args: ($s)<br>
	 * @uses Int32Override::Parse_2 <br>public , args: ($s, $style)<br>
	 * @uses Int32Override::Parse_3 <br>public , args: ($s, $provider)<br>
	 * @uses Int32Override::Parse_4 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int32Override::Parse_5 <br>public , args: ($s, $style, $provider)<br>
	 * @uses Int32Override::Parse_6 <br>public , args: ($s, $provider)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */
	#[MethodOverridePublic]function Parse (\override ...$args){}
	/**
	 * @uses Int32Override::TryParse_1 <br>public , args: ($s, &$result)<br>
	 * @uses Int32Override::TryParse_2 <br>public , args: ($s, &$result)<br>
	 * @uses Int32Override::TryParse_3 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int32Override::TryParse_4 <br>public , args: ($s, $style, $provider, &$result)<br>
	 * @uses Int32Override::TryParse_5 <br>public , args: ($s, $provider, &$result)<br>
	 * @uses Int32Override::TryParse_6 <br>public , args: ($s, $provider, &$result)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @uses Int32Override::TryConvertFromChecked_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int32Override::TryConvertFromChecked_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int32Override::TryConvertFromSaturating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int32Override::TryConvertFromSaturating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Int32Override::TryConvertFromTruncating_1 <br>private , args: ($value, &$result)<br>
	 * @uses Int32Override::TryConvertFromTruncating_2 <br>private , args: ($value, &$result)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Boolean|bool|mixed|\override
	 */

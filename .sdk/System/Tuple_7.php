	...
	\System\Runtime\CompilerServices\ITuple
{
	 ...
	 * @uses Tuple_7Override::Equals_1 <br>private , args: ($other, $comparer)<br>
	 * @uses Tuple_7Override::Equals_2 <br>private , args: ($other, $comparer)<br>
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Tuple_7Override::CompareTo_1 <br>private , args: ($obj)<br>
	 * @uses Tuple_7Override::CompareTo_2 <br>private , args: ($other, $comparer)<br>
	 * @uses Tuple_7Override::CompareTo_3 <br>private , args: ($other, $comparer)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Tuple_7Override::GetHashCode_1 <br>private , args: ($comparer)<br>
	 * @uses Tuple_7Override::GetHashCode_2 <br>private , args: ($comparer)<br>
	 * @uses Tuple_7Override::GetHashCode_3 <br>private , args: ($comparer)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */
	 ...
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses Tuple_7Override::ToString_1 <br>private , args: ($sb)<br>
	 * @uses Tuple_7Override::ToString_2 <br>private , args: ($sb)<br>
	 * @var mixed|\override ...$args
	 ...
	 * @param \T7 $item7
	 */
	public function __construct($item1, $item2, $item3, $item4, $item5, $item6, $item7){}
}
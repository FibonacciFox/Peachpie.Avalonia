...
trait ValueTuple_5Override {
	...
	/**
	 * @deprecated
	 * @param \System\ValueTuple_5 $other [generic: T1,T2,T3,T4,T5]
	 * @return \System\Int32|int
	 */
...
final class ValueTuple_5 extends \System\ValueType implements
	\System\IEquatable_1,
	...
	\System\Runtime\CompilerServices\ITuple
{
	...
	public $Item5;
	/**
	 * @uses ValueTuple_5Override::CompareTo_1 <br>private , args: ($other)<br>
	 * @uses ValueTuple_5Override::CompareTo_2 <br>public , args: ($other)<br>
	 * @uses ValueTuple_5Override::CompareTo_3 <br>private , args: ($other, $comparer)<br>
	 ...
	 * @uses ValueTuple_5Override::GetHashCode_1 <br>private , args: ($comparer)<br>
	 * @uses ValueTuple_5Override::GetHashCode_2 <br>private , args: ($comparer)<br>
	 * @var mixed|\override ...$args
	 * @return \System\Int32|int|mixed|\override
	 */

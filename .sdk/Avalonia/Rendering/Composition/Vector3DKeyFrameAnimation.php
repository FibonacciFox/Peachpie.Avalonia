...
*/
trait Vector3DKeyFrameAnimationOverride {
	/**
	 * @deprecated
...
{
	use Vector3DKeyFrameAnimationOverride;
	...
	public $IsDisposed;
	/**
	 * @uses Vector3DKeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses Vector3DKeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

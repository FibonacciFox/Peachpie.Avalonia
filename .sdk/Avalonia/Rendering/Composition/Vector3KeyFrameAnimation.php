...
*/
trait Vector3KeyFrameAnimationOverride {
	/**
	 * @deprecated
...
{
	use Vector3KeyFrameAnimationOverride;
	/**
	 * @field
	...
	public $IsDisposed;
	/**
	 * @uses Vector3KeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses Vector3KeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

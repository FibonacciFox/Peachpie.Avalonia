...
*/
trait Vector2KeyFrameAnimationOverride {
	/**
	 * @deprecated
	...
	\Avalonia\Rendering\Composition\Animations\ICompositionAnimationBase
{
	...
	public $IsDisposed;
	/**
	 * @uses Vector2KeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses Vector2KeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

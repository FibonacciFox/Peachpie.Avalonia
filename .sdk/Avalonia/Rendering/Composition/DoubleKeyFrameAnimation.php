...
*/
trait DoubleKeyFrameAnimationOverride {
	/**
	 * @deprecated
...
{
	use DoubleKeyFrameAnimationOverride;
	...
	public $IsDisposed;
	/**
	 * @uses DoubleKeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses DoubleKeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

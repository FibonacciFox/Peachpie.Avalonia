...
*/
trait BooleanKeyFrameAnimationOverride {
	/**
	 * @deprecated
	...
	\Avalonia\Rendering\Composition\Animations\ICompositionAnimationBase
{
	...
	public $IsDisposed;
	/**
	 * @uses BooleanKeyFrameAnimationOverride::InsertKeyFrame_1 <br>public , args: ($normalizedProgressKey, $value, $easingFunction)<br>
	 * @uses BooleanKeyFrameAnimationOverride::InsertKeyFrame_2 <br>public , args: ($normalizedProgressKey, $value)<br>

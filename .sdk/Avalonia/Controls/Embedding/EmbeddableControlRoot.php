...
*/
trait EmbeddableControlRootOverride {
	/**
	 * @deprecated
	...
	\System\IDisposable
{
	...
	/**
	 * @uses EmbeddableControlRootOverride::__construct_1 <br>public , args: ($impl)<br>
	 * @uses EmbeddableControlRootOverride::__construct_2 <br>public , args: ()<br>

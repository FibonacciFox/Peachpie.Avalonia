...
class TextChangingEventArgs extends \Avalonia\Interactivity\RoutedEventArgs
{
	...
	public $Source;
	/**
	 * @uses TextChangingEventArgsOverride::__construct_1 <br>public , args: ($routedEvent)<br>
	 * @uses TextChangingEventArgsOverride::__construct_2 <br>public , args: ($routedEvent, $source)<br>

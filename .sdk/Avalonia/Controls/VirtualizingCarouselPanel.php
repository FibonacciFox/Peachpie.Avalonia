...
*/
trait VirtualizingCarouselPanelOverride {
	/**
	 * @deprecated
	...
	\Avalonia\Controls\Primitives\IScrollable
{
	 ...
	 */
	public $Item;
	private function get_CanHorizontallyScroll(){}
	private function set_CanHorizontallyScroll($value){}
	private function get_CanVerticallyScroll(){}
	private function set_CanVerticallyScroll($value){}
	private function get_IsLogicalScrollEnabled(){}
	private function get_ScrollSize(){}
	private function get_PageScrollSize(){}
	/**
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses VirtualizingCarouselPanelOverride::get_Extent_1 <br>private , args: ()<br>
	 * @uses VirtualizingCarouselPanelOverride::get_Extent_2 <br>private , args: ()<br>
	 * @var mixed|\override ...$args
	 * @return \Avalonia\Size|mixed|\override
	 */
	#[MethodOverridePrivate]function get_Extent (){}
	/**
	 * @since @override => public | private | protected
	 * @internal Please ensure that this item can interact with your program before using it, as it may not be available and its use is your responsibility.
	 * @uses VirtualizingCarouselPanelOverride::get_Viewport_1 <br>private , args: ()<br>
	 * @uses VirtualizingCarouselPanelOverride::get_Viewport_2 <br>private , args: ()<br>
	 * @var mixed|\override ...$args
	 * @return \Avalonia\Size|mixed|\override
	 */
	#[MethodOverridePrivate]function get_Viewport (){}
	private function get_Offset(){}
	private function set_Offset($value){}
	private function add_ScrollInvalidated($value){}
	private function remove_ScrollInvalidated($value){}
	private function BringIntoView($target, $targetRect){}
	private function GetControlInDirection($direction, $from){}
	private function RaiseScrollInvalidated($e){}
	private function GetOrCreateElement($items, $index){}
	private function GetRealizedElement($index){}
	...
	private function RecycleElement($element){}
	private function GetTransition(){}
	private function TransitionFinished($task){}

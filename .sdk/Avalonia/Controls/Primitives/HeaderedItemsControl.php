...
*/
trait HeaderedItemsControlOverride {
	/**
	 * @deprecated
...
class HeaderedItemsControl extends \Avalonia\Controls\ItemsControl implements
	...
	\Avalonia\Controls\Presenters\IContentPresenterHost
{
	...
	public $Item;
	/**
	 * @uses HeaderedItemsControlOverride::RegisterContentPresenter_1 <br>private , args: ($presenter)<br>
	 * @uses HeaderedItemsControlOverride::RegisterContentPresenter_2 <br>protected , args: ($presenter)<br>

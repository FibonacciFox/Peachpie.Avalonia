	...
	\Avalonia\Styling\ISetterValue
{
	 ...
	 * @field
	 * @since readonly
	 * @var \Avalonia\StyledProperty_1[Avalonia\Controls\Templates\IControlTemplate]
	 */
	public static $TemplateProperty;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\AttachedProperty_1[System\Boolean]
	 */
	public static $IsTemplateFocusTargetProperty;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\Interactivity\RoutedEvent_1[Avalonia\Controls\Primitives\TemplateAppliedEventArgs]
	 */
	public static $TemplateAppliedEvent;
	/**
	 * @property
	...
	public $Item;
	/**
	 * @param \System\EventHandler_1 $value [generic: Avalonia\Controls\Primitives\TemplateAppliedEventArgs]

...
*/
trait OverlayPopupHostOverride {
	/**
	 * @deprecated
	...
	\Avalonia\Controls\Primitives\PopupPositioning\IManagedPopupPositionerPopup
{
	...
	private function get_Topmost(){}
	private function set_Topmost($value){}
	/**
	 * @return \System\Void|void
	 */
	...
	private function get_ParentClientAreaScreenGeometry(){}
	private function MoveAndResize($devicePoint, $virtualSize){}
	...
	/**
	 * @param \Avalonia\Controls\Primitives\OverlayLayer $overlayLayer
	 */
	public function __construct($overlayLayer){}
}
	...
	\Avalonia\Input\ICommandSource
{
	 ...
	 */
	const pcChecked = ':checked';
	/**
	 * @field
	 * @var \System\String|string
	 */
	const pcPressed = ':pressed';
	/**
	 * @field
	 * @var \System\String|string
	 */
	const pcFlyoutOpen = ':flyout-open';
	/**
	 * @property
	 ...
	 * @uses SplitButtonOverride::CanExecuteChanged_1 <br>private , args: ($sender, $e)<br>
	 * @uses SplitButtonOverride::CanExecuteChanged_2 <br>private , args: ($sender, $e)<br>
	...
	private function PrimaryButton_Click($sender, $e){}
	private function SecondaryButton_Click($sender, $e){}
	private function Flyout_PlacementPropertyChanged($e){}

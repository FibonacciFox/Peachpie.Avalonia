...
trait WindowBaseOverride {
	...
	/**
	 * @param \Avalonia\Platform\IWindowBaseImpl $impl
	 */
	...
	\Avalonia\Input\TextInput\ITextInputMethodRoot
{
	 ...
	 * @field
	 * @since readonly
	 * @var \Avalonia\DirectProperty_2[Avalonia\Controls\WindowBase,System\Boolean]
	 */
	public static $IsActiveProperty;
	/**
	 * @field
	 * @since readonly
	 * @var \Avalonia\DirectProperty_2[Avalonia\Controls\WindowBase,Avalonia\Controls\WindowBase]
	 */
	...
	/**
	 * @param \System\EventHandler_1 $value [generic: Avalonia\Controls\PixelPointEventArgs]
	 * @return \System\Void|void
	 */
	...
	/**
	 * @param \System\EventHandler_1 $value [generic: Avalonia\Controls\WindowResizedEventArgs]
	 * @return \System\Void|void
	 */
	...
	private function HandlePositionChanged($pos){}
	private function HandleActivated(){}
	private function HandleDeactivated(){}
	/**
	...
	/**
	 * @uses WindowBaseOverride::__construct_1 <br>public , args: ($impl)<br>
	 * @uses WindowBaseOverride::__construct_2 <br>public , args: ($impl, $dependencyResolver)<br>

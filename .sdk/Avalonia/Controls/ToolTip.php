	...
	\Avalonia\Controls\Diagnostics\IPopupHostProvider
{
	 ...
	 * @field
	 * @since readonly
	 * @var \Avalonia\AttachedProperty_1[Avalonia\Controls\PlacementMode]
	 */
	 ...
	 * @field
	 * @since readonly
	 * @var \Avalonia\AttachedProperty_1[Avalonia\Controls\ToolTip]
	 */
	protected static $ToolTipProperty;
	/**
	 * @property
	 ...
	 */
	protected function add_Closed($value){}
	/**
	 * @param \System\EventHandler $value
	 * @return \System\Void|void
	 */
	protected function remove_Closed($value){}
	/**
	...
	private static function IsOpenChanged($e){}
	private static function RecalculatePositionOnPropertyChanged($args){}
	...
	private function WindowManagerAddShadowHintChanged($host, $hint){}
